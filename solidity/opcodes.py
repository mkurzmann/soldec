class OpCode:
    ...
    def __init__(self, name: str, code: int, pop: int, push: int, push_bytes: int = 0):
        ...
        Args:
          ...
          push_bytes(int): The number of bytes this op pushes.
        """
        self.name = name
        self.code = code
        self.pop = pop
    ...
    def is_program_splitting(self) -> bool:
        """Predicate: opcode is STOP or INVALID opcode"""
        return self.code == STOP.code or self.code == INVALID.code

    def is_jumpdest(self) -> bool:
        """Predicate: opcode is JUMPDEST opcode"""
    ...
    def is_comparison(self) -> bool:
        """Predicate: opcode's is a comparison operator."""
        return LT.code <= self.code <= ISZERO.code
...
PUSH1 = OpCode("PUSH1", 0x60, 0, 1, 1)
PUSH2 = OpCode("PUSH2", 0x61, 0, 1, 2)
PUSH3 = OpCode("PUSH3", 0x62, 0, 1, 3)
PUSH4 = OpCode("PUSH4", 0x63, 0, 1, 4)
PUSH5 = OpCode("PUSH5", 0x64, 0, 1, 5)
PUSH6 = OpCode("PUSH6", 0x65, 0, 1, 6)
PUSH7 = OpCode("PUSH7", 0x66, 0, 1, 7)
PUSH8 = OpCode("PUSH8", 0x67, 0, 1, 8)
PUSH9 = OpCode("PUSH9", 0x68, 0, 1, 9)
PUSH10 = OpCode("PUSH10", 0x69, 0, 1, 10)
PUSH11 = OpCode("PUSH11", 0x6a, 0, 1, 11)
PUSH12 = OpCode("PUSH12", 0x6b, 0, 1, 12)
PUSH13 = OpCode("PUSH13", 0x6c, 0, 1, 13)
PUSH14 = OpCode("PUSH14", 0x6d, 0, 1, 14)
PUSH15 = OpCode("PUSH15", 0x6e, 0, 1, 15)
PUSH16 = OpCode("PUSH16", 0x6f, 0, 1, 16)
PUSH17 = OpCode("PUSH17", 0x70, 0, 1, 17)
PUSH18 = OpCode("PUSH18", 0x71, 0, 1, 18)
PUSH19 = OpCode("PUSH19", 0x72, 0, 1, 19)
PUSH20 = OpCode("PUSH20", 0x73, 0, 1, 20)
PUSH21 = OpCode("PUSH21", 0x74, 0, 1, 21)
PUSH22 = OpCode("PUSH22", 0x75, 0, 1, 22)
PUSH23 = OpCode("PUSH23", 0x76, 0, 1, 23)
PUSH24 = OpCode("PUSH24", 0x77, 0, 1, 24)
PUSH25 = OpCode("PUSH25", 0x78, 0, 1, 25)
PUSH26 = OpCode("PUSH26", 0x79, 0, 1, 26)
PUSH27 = OpCode("PUSH27", 0x7a, 0, 1, 27)
PUSH28 = OpCode("PUSH28", 0x7b, 0, 1, 28)
PUSH29 = OpCode("PUSH29", 0x7c, 0, 1, 29)
PUSH30 = OpCode("PUSH30", 0x7d, 0, 1, 30)
PUSH31 = OpCode("PUSH31", 0x7e, 0, 1, 31)
PUSH32 = OpCode("PUSH32", 0x7f, 0, 1, 32)
...
IS_CONSTRUCT = [CODECOPY.code, PUSH1.code, RETURN.code]

# with or without DUP2, more than PUSH2 is not possible since maximum bytecode size is 0x6000 (24.576) bytes.
FUNCTION_DETECTION = [[PUSH4.code, DUP2.code, EQ.code, PUSH1.code, JUMPI.code],
                      [PUSH4.code, DUP2.code, EQ.code, PUSH2.code, JUMPI.code],
                      [PUSH4.code, EQ.code, PUSH1.code, JUMPI.code],
                      [PUSH4.code, EQ.code, PUSH2.code, JUMPI.code]]

# non-payable check at the beginning of a block
NON_PAYABLE = [CALLVALUE, DUP1, ISZERO, PUSH2, JUMPI]

# revert block of require statement
REQUIRE_REVERT_BLOCK = [PUSH1, DUP1, REVERT]
